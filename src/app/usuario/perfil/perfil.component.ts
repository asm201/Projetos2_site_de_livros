...
export class PerfilComponent implements OnInit {
  ...
  email: any = this.busca.get('https://ifbooks-production.up.railway.app/usuario?email' || 'projetos2sitedelivros-production-70ef.up.railway.app/cadastra_livro?email') //mudar aqui para https://site-livros-production.up.railway.app/usuario?email
